...
def A_obstacle(x_1s,x_2s,x_1,x_2, x_1o1, x_2o1, x_1o2, x_2o2, h=2):
    ...
    return ((np.exp(-((x_1o1-x_1)**2+(x_2o1-x_2)**2)) +
...
def A_source(x_1s,x_2s,x_1,x_2):
    ...
    return (1/(2*np.pi * 2**2 )) *np.exp(-(1/2**2)*(x_1s-x_1)**2-(1/2**2)*(x_2s-x_2)**2) 
...
def A_obstacle_norm(x_1s,x_2s,x1,x2, x_1o1, x_2o1, x_1o2, x_2o2, dom_start=0, dom_end=10):
    ...
    return (A_source(x_1s,x_2s,x1,x2) * (1-result_box) * 
        (box_mask(x1, x2, dom_start, x_2o1, dom_end, x_2o1 + dom_end-x_2o1))
        + A_obstacle(x_1s,x_2s,x1,x2, x_1o1, x_2o1, x_1o2, x_2o2, h=2) * result_box )
